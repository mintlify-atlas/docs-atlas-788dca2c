...
sidebarTitle: "Tanks"
description: "Create's fluid tanks merge into multi-block structures for large-scale storage. Learn tank connectivity, capacity, and how to read fluid levels with gauges."
---
...
<Note>
  In version 6.0.10, an edge-case bug was fixed where tanks would fail to notify neighbouring blocks of a fluid change under certain conditions (#8535). If you are running an older version and notice Comparators or Gauges not updating correctly, updating to 6.0.10 or later resolves the issue.
</Note>
