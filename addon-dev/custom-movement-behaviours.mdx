...
description: "Register a MovementBehaviour to give a block custom actions when it rides a Create contraption. Implement tick, startMoving, visitNewPosition, and rendering hooks."
---
