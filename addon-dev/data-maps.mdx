...
public class CreateDataMaps {
     ...
     *
     * File path: data/<namespace>/neoforge/data_maps/item/create/regular_blaze_burner_fuels.json
     *
     * Value fields:
     ...
     *
     * File path: data/<namespace>/neoforge/data_maps/item/create/superheated_blaze_burner_fuels.json
     *
     * Value fields:
     *   - burn_time (positive integer) — how long the item burns, in ticks
     */
...
```
src/main/resources/data/mymod/neoforge/data_maps/item/create/regular_blaze_burner_fuels.json
```
...
```
data/mymod/neoforge/data_maps/item/create/superheated_blaze_burner_fuels.json
```
